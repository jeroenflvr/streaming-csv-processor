 ...
 * 
 * <ul>
 *   <li><strong>{@link jeroenflvr.csvprocessor.config}</strong> - Configuration management and factory classes</li>
 *   <li><strong>{@link jeroenflvr.csvprocessor.model}</strong> - Data models and value objects</li>
 *   <li><strong>{@link jeroenflvr.csvprocessor.storage}</strong> - S3/COS storage access layer</li>
 *   <li><strong>{@link jeroenflvr.csvprocessor.processing}</strong> - CSV processing and business logic</li>
 *   <li><strong>{@link jeroenflvr.csvprocessor.streaming}</strong> - Kafka Streams topology construction</li>
 *   <li><strong>{@link jeroenflvr.csvprocessor.util}</strong> - Utility classes and helper functions</li>
 * </ul>
 * 
 ...
 * @since 1.0.0
 */
package jeroenflvr.csvprocessor;
