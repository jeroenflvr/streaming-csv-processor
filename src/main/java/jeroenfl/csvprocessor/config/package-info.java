 ...
 * <p>Key classes:
 * <ul>
 *   <li>{@link jeroenfl.csvprocessor.config.ApplicationConfig} - Application settings and topic configuration</li>
 *   <li>{@link jeroenfl.csvprocessor.config.EnvironmentUtils} - Environment variable access utilities</li>
 *   <li>{@link jeroenfl.csvprocessor.config.KafkaStreamsConfigFactory} - Kafka Streams configuration factory</li>
 *   <li>{@link jeroenfl.csvprocessor.config.S3ClientFactory} - S3 client configuration factory</li>
 * </ul>
 * 
